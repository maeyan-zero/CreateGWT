...
public class TextImpl extends DisplayObjectImpl {
	...
	public final native float getLineHeight() /*-{
	...
	public final native float getMeasuredHeight() /*-{
	  return this.getMeasuredHeight();
  }-*/;

	public final native float getMeasuredLineHeight() /*-{
		return this.getMeasuredLineHeight();
	}-*/;

	public final native float getMeasuredWidth() /*-{
		return this.getMeasuredWidth();
	}-*/;

	//@Override
//	public final native TextImpl clone() /*-{
//		this.clone();
//	}-*/;
